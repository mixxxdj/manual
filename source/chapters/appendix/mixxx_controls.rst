...
:term:`Equalizers <EQ>` and Quick Effects are special effects units.
The EQs are controlled by :mixxx:cogroupref:`[EqualizerRack1_[ChannelI]_Effect1]`.
The Quick Effect knob is controlled by :mixxx:coref:`[QuickEffectRack1_[ChannelI]],super1`
and :mixxx:coref:`[QuickEffectRack1_[ChannelI]],enabled`.
