...
:hwlabel:`Filter` is first quick effect                                                         `FilterIsFirstQuickEffect`                  false                                                                                                             true/false                                                                           Assign the first quick effect to the :hwbtn:`FILTER` button instead of button :hwlabel:`1`. This option is useful if you are used to Filter being the primary quick effect and have it at the top of your quick effect list.
