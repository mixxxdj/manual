...
Alternative assignments for move encoder                                                       `AlternativeMoveMode`                       false                                                                                                             true/false                                                                            Alternative assignments for the move encoder: Rotate: Adjust beatjump size. :hwbtn:`SHIFT` + move encoder: Beatjump. Push + move encoder: adjust pitch up and down.
Relative tempo slider adjustment mode                                                          `RelativeTempoMode`                         false                                                                                                             true/false                                                                            Meant for Sync Lock mode, adjustments to tempo are always relative to the current slider position, so there's no need for soft takeover. :hwbtn:`SHIFT` + moving tempo fader does not change tempo, for resetting slider position.
Shift+tempo slider mode                                                                        `ShiftTempoMode`                            false                                                                                                             true/false                                                                            Only valid when `RelativeTempoMode` is enabled. For low-vision situations, only adjust tempo when :hwbtn:`SHIFT` is held. Helps prevent accidental bumps.
============================================================================================== =========================================== ================================================================================================================= ===================================================================================== ================================================================================================================================================================================================================
