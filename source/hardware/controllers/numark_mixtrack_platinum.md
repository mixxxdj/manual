...
![](../../_static/controllers/undefined/mixtrackplatinum_ortho_3000x1875_web.jpg)
...
output in hardware, so this controller's audio interface is not suitable
...
![](../../_static/controllers/hardware/mixtrack_platinum_labeled.png)
