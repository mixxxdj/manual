...
5                         :hwlabel:`SHIFT` + :hwlabel:`SCRATCH` button            Conxtextaul Go To item  - see https://manual.mixxx.org/2.3/en/chapters/appendix/                                                                                             mixxx_controls.html#control-[Library]-GoToItem
========================  ======================================================  ===========================================================================================
