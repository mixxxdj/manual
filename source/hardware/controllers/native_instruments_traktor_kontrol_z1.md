...
For Windows, download and install the latest Traktor Kontrol Z1 audio driver from the [manufacturer's website](https://www.native-instruments.com/en/support/downloads/drivers-other-files/).
...
<img src="../../_static/controllers/native_instruments_traktor_kontrol_z1.png" alt="Native Instruments Traktor Kontrol Z1 (schematic view)" class="pretty-figures" width="85%">
