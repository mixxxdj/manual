...
[Manufacturer’s product page](https://www.midifighter.com/#Twister) ·
[Forum thread](https://mixxx.discourse.group/t/mapping-the-midifighter-twister/16253)
...
<img src="../../_static/controllers/dj_techtools_midi_fighter_twister.svg" alt="MIDI Fighter Twister with left buttons labeled L1–L3, right buttons labeled R1–R3, and encoders labeled from 1 in the top left to 16 in the bottom right." class="pretty-figures" width="100%">

MIDI Fighter Twister with left buttons labeled L1–L3, right buttons labeled R1–R3, and encoders labeled from 1 in the top left to 16 in the bottom right.
```
## Overview
