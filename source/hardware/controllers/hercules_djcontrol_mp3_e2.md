...
<img src="../../_static/controllers/hercules_djcontrol_mp3_e2_mapping.svg" alt="Hercules DJControl MP3 e2 (schematic view)" width="100%">
...
page](http://ts.hercules.com/eng/index.php?pg=view_files&gid=17&fid=61&pid=241&cid=1). Unfortunately, the configuration tool is only available for Windows and Mac OS X. We are not aware of any
