...
3    Pad 1 - 8  and :hwlabel:`SHIFT` + Pad 1 - 8          see PAD modes section
4    :hwlabel:`CUE` button                              When playing, returns to the cue point and pauses. If stopped, sets a cue point at the current location. If stopped and at a cue point, plays from that point until released
...
Effect   :hwlabel:`Transition FX` blinking
Jump     :hwlabel:`Transition FX` and all pads blinking
======== ====================================================
...
Loop     Pad 1 - 8                                  Set and enables or stops loop over beats (increasing size PADs 1-8) |
Loop     :hwlabel:`SHIFT` + Pad 1 - 8               Set and enables or stops looproll over beats (increasing size PADs 1-8) |
Effect   Pad 1 - 4 / :hwlabel:`SHIFT` + Pad 1 - 4   Play/Stop Sampler 1 - 4
Effect   Pad 5 - 7 / :hwlabel:`SHIFT` + Pad 5 - 8   Activate FX1/FX2 Effect 1 - 3
Effect   Pad 8 / :hwlabel:`SHIFT` + Pad 8           BPM Tap- Button
Jump     Pad 1 - 8                                  Jump forward over beats (increasing distance PADs 1-8)
Jump     :hwlabel:`SHIFT` + Pad 1 - 8               Jump back over beats (increasing distance PADs 1-8)
======== ========================================== =========================================
...
3    :hwlabel:`CFX` knobs                                   EffectChain superknob
...
5    :hwlabel:`SHIFT` + Channel faders                      zero->notzero: "FADER Start", playtrack. notzero->zero: "FADER Stop", pause track and set cue
6    :hwlabel:`Transition FX` button                        Change pad modes (Hotcue - Loop - Effect) / Return from Jump mode
6    :hwlabel:`SHIFT` + :hwlabel:`Transition FX` button     Toggle in or out of beatjump pad mode
