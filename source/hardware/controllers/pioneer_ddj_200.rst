...
2    double-click :hwlabel:`SHIFT` button              4-deck mode: Change active deck (:hwlabel:`BEAT SYNC` will blink on alternate deck control)
...
6    :hwlabel:`SHIFT` + :hwlabel:`BEAT SYNC` button    Change RPM Range of :hwlabel:`TEMPO` slider
