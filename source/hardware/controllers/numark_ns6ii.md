...
:::{sectionauthor} Nikolaus Einhauser <nikolaus.einhauser@mixxx.org>

:::
```{figure-md}
:align: center

<img src="../../_static/controllers/numark_ns6ii_schematics/top_view.svg" alt="Numark NS6II (schematic view)" class="pretty-figures" width="100%">
...
-  [Manufacturer’s product page](http://www.numark.com/product/ns6ii)
-  [Serato DJ Hardware Page](https://serato.com/dj/hardware/numark-ns6ii)
-  [User Guide](https://www.numark.com/images/product_downloads/NS6II-UserGuide-v1.1.pdf)
...
You can download the latest Windows & MacOS drivers and firmware from the [manufacturer’s website](https://www.numark.com/product/ns6ii).
...
<img src="../../_static/controllers/numark_ns6ii_schematics/top_view_annotated.svg" alt="Numark NS6II (Annotated Topview)" class="pretty-figures" width="100%">
...
<img src="../../_static/controllers/numark_ns6ii_schematics/mixer.svg" alt="" style="float:left;width:20%">
...
<img src="../../_static/controllers/numark_ns6ii_schematics/front_view.svg" alt="NS6II (front view)" class="pretty-figures" width="100%">
...
<img src="../../_static/controllers/numark_ns6ii_schematics/fx_unit.svg" alt="NS6II (Effect Unit)" class="pretty-figures" width="50%">
...
<img src="../../_static/controllers/numark_ns6ii_schematics/display.svg" alt="NS6II (jogwheel display)" class="pretty-figures" width="50%">
...
<img src="../../_static/controllers/numark_ns6ii_schematics/performancepads/generic.svg" alt="NS6II (performance pads)" class="pretty-figures" width="100%">
...
| 31       |  {hwlabel}`SAMPLER`  |       Samplers 1-8 Norm | l  Samplers 1-8 Velocity-sensiti | e |
...
<img src="../../_static/controllers/numark_ns6ii_schematics/performancepads/hotcues.svg" alt="NS6II (performance pads)" class="pretty-figures" width="100%">
...
<img src="../../_static/controllers/numark_ns6ii_schematics/performancepads/auto_loop.svg" alt="NS6II (autoloop)" class="pretty-figures" width="100%">
...
<img src="../../_static/controllers/numark_ns6ii_schematics/performancepads/loop_control.svg" alt="NS6II (loop control)" class="pretty-figures" width="100%">
...
<img src="../../_static/controllers/numark_ns6ii_schematics/performancepads/key_control.svg" alt="NS6II (key control)" class="pretty-figures" width="100%">
...
<img src="../../_static/controllers/numark_ns6ii_schematics/performancepads/sampler.svg" alt="NS6II (sampler pads)" class="pretty-figures" width="100%">
...
<img src="../../_static/controllers/numark_ns6ii_schematics/performancepads/beat_jump.svg" alt="NS6II (beat jump)" class="pretty-figures" width="100%">
...
<img src="../../_static/controllers/numark_ns6ii_schematics/performancepads/intro_outro.svg" alt="NS6II (beat jump)" class="pretty-figures" width="100%">
...
<img src="../../_static/controllers/numark_ns6ii_schematics/performancepads/beatgrid_settings.svg" alt="NS6II (beatgrid)" class="pretty-figures" width="100%">
