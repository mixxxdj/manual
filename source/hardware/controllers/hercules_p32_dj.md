...
-  [Manufacturer’s product page](https://www.hercules.com/en-us/product/herculesp32dj/)
-  [Manufacturer’s technical support page](https://support.hercules.com/en/product/p32dj-en/)
-  [Forum thread](https://mixxx.discourse.group/t/hercules-p32-dj-controller-mapping/15804)
...
driver](https://support.hercules.com/en/product/p32dj-en/) on Windows to be able to use the {ref}`ASIO sound API <preferences-sound-api>`.
...
-  **EQ knobs, volume faders, crossfader, headphone button, play, cue, sync, and load** all behave as labeled. Dry/wet knob can optionally be used as pregain (see _dryWetKnobAsPregain_ variable)
