...
![](../../_static/controllers/numark_mixtrack_angle_large.jpg)
...
![](../../_static/controllers/numarkmixtrack_tech.png)
...
## Known problems
  ...
  - The pitch on the controller has a very short run. Thus, having it
    ...
    highly recommended
  - The autolooping functions, although implemented are quite flawed. The
