...
-  [Forum thread](https://mixxx.discourse.group/t/mapping-for-stanton-djc-4/14074)
...
However, if you wish to use the {ref}`ASIO sound API <preferences-sound-api>` under Windows, please install the latest driver package available from the [Product page](https://web.archive.org/web/20220909115203/https://www.stantondj.com/stanton-controllers-systems/djc4.html).
