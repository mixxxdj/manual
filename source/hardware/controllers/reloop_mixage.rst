...
9       :hwlabel:`FX SEL` / :hwlabel:`MASTER`      Select effect in effect rack N for adjustment. Button is lit if an effect slot is selected.                                                                                  Toggle if deck N is sync leader.
