...
<img src="../../_static/controllers/arturia_keylab88.svg" alt="Arturia KeyLab 88" class="pretty-figures" width="100%">
...
:::{note}
Arturia also made 61 and 25 key versions of this keyboard.
...
:::{note}
Currently Mixxx must be focused for the library navigation options to
...
| Cue | {hwlabel}`⏹` | If track is playing: stops the track and resets position to the main cue point<br><br>If playback is stopped: sets the main cue point |
