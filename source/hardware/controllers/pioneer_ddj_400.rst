...
6     :hwlabel:`HEADPHONES` :hwlabel:`MIXING`                  Adjusts between headphone :hwlabel:`CUE` and :hwlabel:`MASTER` levels
                                                               sent to headphones (this is implemented in hardware and does not
                                                               control the headphone mix in Mixxx).
