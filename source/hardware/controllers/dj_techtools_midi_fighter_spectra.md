# DJ TechTools MIDI Fighter Spectra
  ...
  - [Manufacturer's product page](https://store.djtechtools.com/products/midi-fighter-spectra)
  - [Forum thread](https://mixxx.discourse.group/t/dj-techtools-midi-fighter-spectra/31554)
...
<img src="../../_static/controllers/dj_techtools_midi_fighter_spectra.svg" alt="MIDI Fighter Spectra with left buttons labeled L1–L3, right buttons labeled R1–R3, and arcade buttons labeled from 1 in the top left to 16 in the bottom right." class="pretty-figures" width="100%">

MIDI Fighter Spectra with left buttons labeled L1–L3, right buttons labeled R1–R3, and arcade buttons labeled from 1 in the top left to 16 in the bottom right.
```
