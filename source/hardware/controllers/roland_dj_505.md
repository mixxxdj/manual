...
<img src="../../_static/controllers/roland_dj_505.svg" alt="Roland DJ-505 (schematic view)" class="pretty-figures" width="100%">
...
-  [Manufacturer’s product page](https://www.roland.com/global/products/dj-505/)
-  [Serato DJ Hardware Page](https://serato.com/dj/hardware/roland-dj-505)
...
You can download the latest Windows & MacOS drivers and firmware from the [manufacturer’s website](https://www.roland.com/global/products/dj-505/downloads/).
...
<img src="../../_static/controllers/roland_dj_505_browser.svg" alt="Roland DJ-505 (browser section)" class="pretty-figures" width="45%">
...
<img src="../../_static/controllers/roland_dj_505_deck.svg" alt="Roland DJ-505 (deck section)" class="pretty-figures" width="80%">
...
| 10       |  {hwlabel}`LOOP` area: {hwlabel}`SHIFT` + {hwlabel}`AUTO  LOOP` butto |   Toggle looping. |
...
<img src="../../_static/controllers/roland_dj_505_mixer.svg" alt="Roland DJ-505 (mixer section)" class="pretty-figures" width="50%">
...
<img src="../../_static/controllers/roland_dj_505_effects.svg" alt="Roland DJ-505 (effects section)" class="pretty-figures" width="60%">
...
<img src="../../_static/controllers/roland_dj_505_trs.svg" alt="Roland DJ-505 (TR-S section)" class="pretty-figures" width="100%">
...
<img src="../../_static/controllers/roland_dj_505_performancepads.svg" alt="Roland DJ-505 (performance pads)" class="pretty-figures" width="65%">
...
-  Some performance pad modes are missing
   ...
   Slicer Loop,
   Flip [[Launchpad Bug #9271](https://github.com/mixxxdj/mixxx/issues/9271)])
