...
(reloop-terminal-mix-series-maintenance)=

## Controller hardware / Maintenance


The jog wheels’ touch sensitivity can be adjusted separately.
Refer to the [official manual](http://www.reloop.com/media/custom/upload/Reloop-TM4_Factory+JogReset.pdf) for instructions.
...
(reloop-terminal-mix-series-options)=
