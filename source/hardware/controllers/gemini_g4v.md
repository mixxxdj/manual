...
<!-- Image removed (not found): ![g4v-top-4-893x490.jpg](../../_static/controllers/g4v-top-4-893x490.jpg) -->
...
output line. This lines are not going through the soundcard but mixed
...
```
   ...
   * If the deck was in slip mode before entering in vinyl mode, the play head will move to the position it will have been if no manipulation happened, useful for scratching without losing the beat
