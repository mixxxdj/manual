...
-  [Manufacturer’s product page](https://www.numark.com/product/ns4fx)
-  [Forum thread](https://mixxx.discourse.group/t/numark-ns4-fx-mapping-repository/32767)
...
-  **Control stems effects with EQ knobs** When enabled, the EQ knobs of decks 3 and 4 control the volume of the stem effects of decks 1 and 2.
...
<img src="../../_static/controllers/numark_ns4fx.png" alt="Numark NS4FX (schematic view)" class="pretty-figures" width="100%">
...
<img src="../../_static/controllers/numark_ns4fx_display.png" alt="Numark NS4FX jog wheel display (schematic view)" class="pretty-figures" width="75%">
