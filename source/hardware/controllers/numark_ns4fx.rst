...
.. figure:: ../../_static/controllers/numark_ns4fx.png
   ...
   15. **Beats Multiplier:** As Mixxx does not have a single BEATS knob, you can use it to control the **master volume** gain.
       **SHIFT + Turn** Controls effect units superknobs.
