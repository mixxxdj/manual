...
-  [Manufacturer’s product page](https://yaeltex.com/product/minimixxx/)
...
1. Go to [Yaeltex Kilowhat](https://kilowhat.yaeltex.com/) configuration site.
...
<img src="../../_static/controllers/yaeltex_minimixxx.jpg" alt="Yaeltex Minimixxx (photo by Yaeltex)" class="pretty-figures" width="100%">
