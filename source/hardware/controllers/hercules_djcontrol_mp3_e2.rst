...
+-----------------------------+---------------------------+--------+
| Adjust the cue/main mix in  | Shift + Deck B pitch knob | 3      |
...
| Function                            | Control             | number |
+=====================================+=====================+========+
| Loads the current highlighted track | Shift + Load A/B    | 18     |
| into the corresponding sampler (1   |                     |        |
| or 2)                               |                     |        |
+-------------------------------------+---------------------+--------+
...
+-----------------------------+-----------------------------+--------+
| Brake Effect                | Supershift + Forward (stops | 12     |
|                             | on release)                 |        |
+-----------------------------+-----------------------------+--------+
...
+-----------------------------+-------------------------+--------+
| If hotcue X is set, clears  | Shift + 1/2/3/4 buttons | 11     |
| its hotcue status.          |                         |        |
+-----------------------------+-------------------------+--------+
...
+-------------+-------------+-------------+-------------+-------------+
| Number      | Control     | Function    | shifted     | S           |
|             |             |             |             | upershifted |
+=============+=============+=============+=============+=============+
...
|             |             | TalkOver    |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 6           | Folder      | Toggles     | P           | Stop        |
|             |             | (expands    | lay/Stutter | sampler 1/3 |
...
|             |             | item        |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 10          | Files       | Toggles     | P           | Stop        |
|             |             | (expands    | lay/Stutter | sampler 2/4 |
...
+-------------+-------------+-------------+-------------+-------------+
| Number      | Control     | Simple      | Shifted     | S           |
|             |             | function    | function    | upershifted |
|             |             |             |             | function    |
+=============+=============+=============+=============+=============+
| 1           | Pitchbend   | Temporary   | + double    | + Filter    |
|             | +/-         | Holds the   | loop        | High Kill   |
|             |             | pitch 4%    | - half loop | - Filter    |
|             |             | higher      |             | Low Kill    |
|             |             | while       |             |             |
|             |             | pressed     |             |             |
+-------------+-------------+-------------+-------------+-------------+
...
|             | buttons     | 1 - loop-in | 1 - Loop    | 1 - Clear   |
|             |             | 2 -         | 1/4         | loop        |
|             |             | loop-out    | 2 - Loop    | 2 - Loop    |
|             |             | 3 - Toggles | 1/2         | 1/8         |
|             |             | current     | 3 - Loop 1  | 3 - Loop 8  |
|             |             | loop On or  | 4 - Loop 2  | 4 - Loop 16 |
|             |             | Off         | Hotcue      | Hotcue      |
|             |             | 4 - Loop 4  | mode:       | mode:       |
|             |             | Hotcue      | If hotcue X | Nothing     |
|             |             | mode:       | is set,     |             |
|             |             | 1, 2, 3 and | clears its  |             |
|             |             | 4: If       | hotcue      |             |
|             |             | hotcue X is | status.     |             |
|             |             | set, seeks  |             |             |
|             |             | the player  |             |             |
...
|             |             |             |             | pushed)     |
+-------------+-------------+-------------+-------------+-------------+
| 13          | Sync        | Au          | Adjust      | Kill Mid    |
|             |             | tomatically | BeatGrid    |             |
|             |             | sets pitch  |             |             |
|             |             | so the BPM  |             |             |
|             |             | of the      |             |             |
|             |             | other deck  |             |             |
