...
- [Forum thread](https://mixxx.discourse.group/t/novation-launchpad-mapping/12471)
...
<!-- Image removed (not found): ![layout](../../_static/controllers/docs/lp-mki-layout.png) -->
...
<!-- Image removed (not found): [1]: docs/lp-1.png -->
<!-- Image removed (not found): [2]: docs/lp-2.png -->
<!-- Image removed (not found): [3]: docs/lp-3.png -->
<!-- Image removed (not found): [4]: docs/lp-4.png -->
...
<!-- Image removed (not found): [grande]: docs/lp-mki-grande.png -->
<!-- Image removed (not found): [tall]: docs/lp-mki-tall.png -->
<!-- Image removed (not found): [juggler]: docs/lp-mki-juggler.png -->
<!-- Image removed (not found): [short]: docs/lp-mki-short.png -->
<!-- Image removed (not found): [sampler]: docs/lp-mki-sampler.png -->
