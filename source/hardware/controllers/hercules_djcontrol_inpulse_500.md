...
<img src="../../_static/controllers/hercules_djcontrol_inpulse_500.svg" alt="Hercules DJControl Inpulse 500 (schematic view)" class="pretty-figures" width="100%">


Hercules DJControl Inpulse 500 (schematic view)
```
-  [Manufacturer’s product page](https://web.archive.org/web/20241013231548/https://www.hercules.com/en-us/product/djcontrol-inpulse-500/)
-  [Manufacturer’s support and downloads page](https://support.hercules.com/en/product/djcontrolinpulse500-en//)
-  [Forum thread](https://mixxx.discourse.group/t/hercules-djcontrol-inpulse-500/19739/101/)
...
the [Support page](https://support.hercules.com/en/product/djcontrolinpulse500-en//).
...
<img src="../../_static/controllers/hercules_djcontrol_inpulse_500_modes.svg" alt="Hercules DJControl Inpulse 500 modes overview" class="pretty-figures" width="60%">
...
<img src="../../_static/controllers/hercules_djcontrol_inpulse_500_loop.svg" alt="Hercules DJControl Inpulse 500 (loop mode pads)" class="pretty-figures" width="60%">

Hercules DJControl Inpulse 500 (loop mode pads)
```
| Control                                                         |  Function |
| --- | --- |
...
<img src="../../_static/controllers/hercules_djcontrol_inpulse_500_loop_shift.svg" alt="Hercules DJControl Inpulse 500 (loop mode pads, shift+pad)" class="pretty-figures" width="60%">

Hercules DJControl Inpulse 500 (loop mode pads, shift+pad)
```
| Control                                                         |  Function |
| --- | --- |
...
<img src="../../_static/controllers/hercules_djcontrol_inpulse_500_transport.svg" alt="Hercules DJControl Inpulse 500 (transport mode pads)" class="pretty-figures" width="60%">

Hercules DJControl Inpulse 500 (transport mode pads)
```
| Control                                                         |  Function |
| --- | --- |
...
<img src="../../_static/controllers/hercules_djcontrol_inpulse_500_roll.svg" alt="Hercules DJControl Inpulse 500 (roll mode pads)" class="pretty-figures" width="60%">

Hercules DJControl Inpulse 500 (roll mode pads)
```
| Control                                                         |  Function |
| --- | --- |
...
<img src="../../_static/controllers/hercules_djcontrol_inpulse_500_fx.svg" alt="Hercules DJControl Inpulse 500 (FX mode pads)" class="pretty-figures" width="60%">

Hercules DJControl Inpulse 500 (FX mode pads)
```
```{figure-md}
:align: center

<img src="../../_static/controllers/hercules_djcontrol_inpulse_500_fx_shift.svg" alt="Hercules DJControl Inpulse 500 (FX mode shift + pads)" class="pretty-figures" width="60%">

Hercules DJControl Inpulse 500 (FX mode shift + pads)
```
| Control                                                         |  Function |
| --- | --- |
...
<img src="../../_static/controllers/hercules_djcontrol_inpulse_500_jump.svg" alt="Hercules DJControl Inpulse 500 (Beatjump mode pads)" class="pretty-figures" width="60%">

Hercules DJControl Inpulse 500 (Beatjump mode pads)
```
| Control                                                         |  Function |
| --- | --- |
...
<img src="../../_static/controllers/hercules_djcontrol_inpulse_500_jump_shift.svg" alt="Hercules DJControl Inpulse 500 (Beatjump mode shift + pads)" class="pretty-figures" width="60%">

Hercules DJControl Inpulse 500 (Beatjump mode shift + pads)
```
| Control                                                         |  Function |
| --- | --- |
