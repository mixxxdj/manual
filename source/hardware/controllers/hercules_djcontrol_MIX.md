...
-  [Manufacturer’s product page](https://www.hercules.com/en-us/product/djcontrol-mix/)
-  [Manufacturer’s support and downloads page](https://support.hercules.com/en/product/djcontrolmix-en/)
-  [Forum thread](https://mixxx.discourse.group/t/hercules-contrl-mix-mapping/26581)
...
| Control                                                         |  Function |
| --- | --- |
| {hwlabel}`Crossfader` 				                             Fades be | ween deck 1 and 2 |
| {hwlabel}`MASTER` 				                             	 Controls t | e main output volume |
| {hwlabel}`HEADPHONE` knob				                         Controls  | he headphone output volume |
| {hwlabel}`Headphone` buttons				                     Toggles PF | /Cue (headphones) for specific deck |
| {hwlabel}`SHIFT` + {hwlabel}`CUE MASTER`						 Toggles between  | eadphone’s audio source (Cue / Main) |
| {hwlabel}`SHIFT` + {hwlabel}`SPLIT ON/OFF` 						 Toggles split | cue (headphones) |
| {hwlabel}`Volume` 				                             	 Controls d | ck volume |
| {hwlabel}`Filter/Bass` knob				                         Control |  deck’s filter/ equalizer low frequencies |
| {hwlabel}`Filter/Bass` button				                     Toggles k | ob control between Filter/Bass |
...
| {hwlabel}`SHIFT` + :hwlabel: `Pad 1 - 3`						 Select Next avai | able Effect |
