...
-  The main keyboard is mapped to the 64 Sampler slots for Skins that have them, since it has 25 keys. The upper Samplers can be accessed by pressing the :hwlabel:`OCTAVE UP`/`hwlabel:`OCTAVE DOWN` buttons.
-  The 8 pressure sensitive drum pads are attached to 6 Effects, 3 for FX1 and 3 for FX2, the last two pads are mapped for a fourth effect for when it will be available.
