...
![scs3dangle.jpg](_static/controllers/stantonscs/scs3dangle.jpg)
...
![](../../_static/controllers/hardware/stantonscs/scs3d_preset.jpg)
...
![](../../_static/controllers/hardware/stantonscs/modebuttons.jpg)
...
![](../../_static/controllers/hardware/stantonscs/slidermode.jpg) **v2.0.1 and above:**
...
![](../../_static/controllers/hardware/stantonscs/slidermode.jpg)
...
![](../../_static/controllers/hardware/stantonscs/circlemode.gif) **Vinyl mode (red)**
...
![](../../_static/controllers/hardware/stantonscs/slidermode.jpg) You are in this mode only
...
chains with buttons B11 through B14. B11 assigns effect chain 1, B12
assigns effect chain 2, B13 assigns chain 3, and B14 assigns chain 4 to
the active deck. The effects that have the current deck assigned are
shown in blue. While FX is held, S2 can be used to scroll through
different effects. To load the next effect, touch top half of the slider
and touch the bottom half to load the previous effect into the currently
active effect slot.
...
![](../../_static/controllers/hardware/stantonscs/circlemode.gif)
