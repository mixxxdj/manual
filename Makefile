...
ALLSPHINXOPTS   = -d $(BUILDDIR)/doctrees $(PAPEROPT_$(PAPER)) $(SPHINXOPTS) -c source source
...
html:
	$(SPHINXMULTIVERSION) -b html $(ALLSPHINXOPTS) $(BUILDDIR)/html
	@echo
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/Mixxx"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/Mixxx"
	@echo "# devhelp"
